                        ...
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    ...
                                    <div class="m-1">Mon, Aug 15 2025 05:42:43 PM</div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">ULAB Business Club</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#"> On 28th March 2024, ULAB Business Club members took part in the "Entrepreneurship Bootcamp" organized in collaboration with local startup mentors. Through interactive sessions, case studies, and group activities, students gained hands-on experience in business planning, innovation strategies, and leadership development.</a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">farmgate, Jan 11</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    ...
                                    <div class="m-1">June  21, 2025 02:41 pm</div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">ULAB Photography Club  </div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">On 12th March 2024, members of the ULAB Photography Club actively participated in the "Urban Storytelling" workshop held at the ULAB Permanent Campus. Students explored different techniques of street and portrait photography, capturing the vibrant life around them. The event encouraged creativity, technical skill development, and visual storytelling.</a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">Uttara, Sep 15</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden w-full m-4 shadow-sm flex flex-col md:flex-row justify-center">
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                ...
                                <div class="font-bold text-black text-xl m-2">Robotics Club </div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">On 26th March 2024, ULAB Photography Club members actively participated in the "Capture the Campus" event at the ULAB Permanent Campus. Students showcased their skills by photographing campus life, architecture, and nature. The event promoted creativity, storytelling through visuals, and environmental awareness.
                                ...
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600"> CTG Dec 08</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden w-full m-4 shadow-sm flex flex-col md:flex-row justify-center">
                        <div class="flex flex-col md:flex-row items-center">
                            ...
                            <div class="md:w-2/3 m-4 ">
                                <div class="flex text-gray-500 text-sm m-2">
                                    <!-- <div class="m-1 font-bold">Vlog,</div> -->
                                    <div class="m-1">December 05, 2024 9:39 am </div>
                                </div>
                                <div class="font-bold text-black text-xl m-2">Computer Club</div>
                                <div class="text-sm text-gray-500 mt-4 m-2"><a href="#">On 15th February 2025, ULAB Computer Club members enthusiastically participated in the "Tech Talk and Coding Sprint" at the ULAB Research Building. Students engaged in workshops, coding challenges, and tech discussions, fostering innovation, problem-solving skills, and collaborative learning.</a></div>
                                <div class="flex cursor-pointer">
                                    ...
                                    <div class="grid m-1">
                                        ...
                                        <div class=" text-sm hover:text-gray-600">Kuakata Beach Dec 5</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Dhaka ,BD.</a>
                ...
                <li>
                  <a class="text-gray-600 hover:text-gray-800">Email: hafiz.ullah.cse@ulab.edu.bd</a>
                </li>
              </nav>
            </div>
